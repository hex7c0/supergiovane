...
var cluster = require("cluster"), http = require("http"), resolve = require("path").resolve, status = http.STATUS_CODES, express = require("express"), logger = require("logger-request"), semver = require("semver"), VERSION = JSON.parse(require("fs").readFileSync(__dirname + "/package.json"));
