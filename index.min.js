    ...
    if (app.get("/api/:pkg/:extra?", function(req, res, next) {
        ...
        https.get({
            ...
            response.on("data", function(chunk) {
                ...
                try {
                    "gzip" === response.headers["content-encoding"] && (body = zlib.unzipSync(body)), 
...
var cluster = require("cluster"), https = require("https"), http = require("http"), resolve = require("path").resolve, status = http.STATUS_CODES, express = require("express"), logger = require("logger-request"), semver = require("semver"), setHeader = require("setheaders").setWritableHeader, zlib = require("zlib"), VERSION = JSON.parse(require("fs").readFileSync(__dirname + "/package.json"));
